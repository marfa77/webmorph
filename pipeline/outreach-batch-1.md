...
Первое письмо отправлено **всем 5** контактам из этого батча — **24 марта 2026**.
...
| Поле | Значение |
|------|----------|
| To | info@goldenpestuae.com |
| Subject | goldenpestuae.com — quick note (webmorp.art) |
...
Reply “yes” to queue. No obligations
...
## 2 — Eagles Locksmith (Cincinnati)

| Поле | Значение |
|------|----------|
| To | info@eagleslocksmith.com |
| Subject | eagleslocksmith.com — quick note (webmorp.art) |
...
## 3 — Fresh Scent Laundry

| Поле | Значение |
|------|----------|
| To | info@freshscentlaundry.com |
| Subject | freshscentlaundry.com — quick note (webmorp.art) |
...
| Поле | Значение |
|------|----------|
| To | info@urbanwash.com |
| Subject | urbanwash.com — quick note (webmorp.art) |
...
## 5 — Flower Store Dubai (funeral flowers)

| Поле | Значение |
|------|----------|
| To | info@flowerstoredubai.com |
| Subject | flowerstoredubai.com — quick note (webmorp.art) |
...
Первое письмо: 2026-03-24 (всем пяти).

| # | Email |
|---|--------|
| 1 | info@goldenpestuae.com |
| 2 | info@eagleslocksmith.com |
| 3 | info@freshscentlaundry.com |
| 4 | info@urbanwash.com |
| 5 | info@flowerstoredubai.com |

---

## Шаблоны и примеры

На webmorp.art: референсы шаблонов (можно выбрать), портфолио. Если не выбирают — направление с нашей стороны по опыту. В письмах это сведено к одной короткой строке + блок «What you get».
